...
return array(
  ...
  'work_phone' => 'Telefone',
  'address' => 'Endereço',
  'address1' => 'Rua',  'address2' => 'Complemento',
  'city' => 'Cidade',
  'state' => 'Estado',
  'postal_code' => 'CEP',
  'country_id' => 'País',
  ...
  'invoice_terms' => 'Condições do Pedido',
  'save_as_default_terms' => 'Salvar como condição padrão',
  'download_pdf' => 'Baixar PDF',
  'pay_now' => 'Pagar agora',
  'save_invoice' => 'Salvar Pedido',
  'clone_invoice' => 'Clonar Pedido',
  'archive_invoice' => 'Arquivar Pedido',
  'delete_invoice' => 'Apagar Pedido',
  'email_invoice' => 'Enviar Pedido',
  'enter_payment' => 'Informar Pagamento',
  'tax_rates' => 'Impostos',
  'rate' => 'Valor',
  'settings' => 'Configurações',
  'enable_invoice_tax' => 'Permitir especificar a <b>taxa do pedido</b>',
  ...
  // recurring invoices
  'recurring_invoices' => 'Pedidos Recorrentes',
  'recurring_help' => '<p>Enviar automaticamente aos clientes os mesmos pedidos semanalmente, mensalmente, bimenstralmente, trimestralmente ou anualmente. </p>
  <p>Use :MONTH, :QUARTER ou :YEAR para datas dinâmicas. Operadores matemáticos também funcionam, por exemplo :MONTH-1.</p>
  <p>Exemplo de variáveis de um pedido:</p>
  <ul>
  ...
  'invoices_past_due' => 'Pedidos Vencidos',
  'upcoming_invoices' => 'Próximos Pedidos',
  'average_invoice' => 'Média por Pedido',
  ...
  'email_sent' => 'Notificar-me por e-mail quando o pedido for <b>enviado</b>',
  'email_viewed' => 'Notificar-me por e-mail quando o pedido for <b>visualizado</b>',
  'email_paid' => 'Notificar-me por e-mail quando o pedido for <b>pago</b>',
  'site_updates' => 'Atualizações',
  'custom_messages' => 'Mensagens Customizadas',
  'default_invoice_terms' => 'Definir condições padrões do pedido',
  ...
  'registration_required' => 'Favor logar-se para enviar um pedido por e-mail',
  ...
  'updated_invoice' => 'Pedido atualizado com sucesso',
  'created_invoice' => 'Pedido criado com sucesso',
  'cloned_invoice' => 'Pedido clonado com sucesso',
  'emailed_invoice' => 'Pedido enviado por e-mail com sucesso',
  'and_created_client' => 'e o cliente foi criado',
  'archived_invoice' => 'Pedido arquivado com sucesso',
  'archived_invoices' => ':count pedidos arquivados com sucesso',
  'deleted_invoice' => 'Pedido apagados com sucesso',
  'deleted_invoices' => ':count pedidos apagados com sucesso',
  ...
  'invoice_message' => 'Para visualizar seu pedido de :amount, clique no link abaixo.',
  ...
  'notification_invoice_viewed' => 'O cliente :client visualizou o pedido :invoice de :amount.',
  ...
  'password' => 'Senha',
  'close' => 'Fechar',
  'invoice_subject' => 'Novo pedido :invoice de :account',
  ...
  'update_products_help' => 'Atualizando no pedido o <b>produto também será atualizado</b>',
  ...
  'invoice_design' => 'Modelo do Pedido',
  'specify_colors' => 'Definição de Cores',
  'specify_colors_label' => 'Selecione as cores para seu pedido',

  'chart_builder' => 'Contrutor de Gráficos',
  'ninja_email_footer' => 'Use :site para gerenciar os orçamentos e pedidos de seus clientes!',
  ...
  'save_quote' => 'Salvar Orçamento',
  'email_quote' => 'Enviar Orçamento',
  'clone_quote' => 'Clonar Orçamento',
  'convert_to_invoice' => 'Gerar Pedido',
  'view_invoice' => 'Visualizar Pedido',
  ...
  'converted_to_invoice' => 'Pedido gerado',
  ...
  'invoice_fields' => 'Campos do Pedido',
  'invoice_options' => 'Opções do Pedido',
  'hide_quantity' => 'Ocultar quantidade',
  'hide_quantity_help' => 'Se a quantidade dos itens é sempre 1, então você pode definir para nao exibir na seu pedido.',
  ...
  'confirm_email_invoice' => 'Deseja enviar este pedido?',
  'confirm_email_quote' => 'Deseja enviar este orçamento?',
  'confirm_recurring_email_invoice' => 'Deseja enviar este pedido?',
  ...
  'invoice_settings' => 'Configuração dos Pedidos',
  'invoice_number_prefix' => 'Prefixo na Numeração dos Pedidos',
  'invoice_number_counter' => 'Numeração dos Pedidos',
  'quote_number_prefix' => 'Prefixo na Numeração dos Orçamentos',
  'quote_number_counter' => 'Numeração dos Orçamentos',
  'share_invoice_counter' => 'Usar numeração dos pedidos',
  'invoice_issued_to' => 'Pedido gerado para',
  'invalid_counter' => 'Para evitar conflitos defina prefíxos de numeração para Pedidos e Orçamentos',
  ...
  'restore' => 'Restaurar',
  'restore_invoice' => 'Restaurar Pedido',
  ...
  'restored_invoice' => 'Pedido restaurado',
  ...
  'invoice_history' => 'Histórico de Pedidos',
  ...
  'invoice_email' => 'E-mail de Pedidos',
  ...
  'invoice_footer' => 'Rodapé do Pedido',
  ...
  'invoice_task' => 'Gerar Pedido',
  'invoice_labels' => 'Etiquetas dos Pedidos',
  'prefix' => 'Prefixo',
  'counter' => 'Contador',
  ...
  'add_to_invoice' => 'Adicionar no Pedido :invoice',
  'create_new_invoice' => 'Criar pedido',
  ...
  'new_recurring_invoice' => 'Novo Pedido Recorrente',
  'recurring_invoice' => 'Pedido Recorrente',
  'recurring_too_soon' => 'Fora do prazo para novo pedido recorrente, agendamento para :date',
  'created_by_invoice' => 'Criada a partir do Pedido :invoice',
  ...
  'invoices_sent' => ':count pedido(s) enviado(s)',
  ...
  'iframe_url_help2' => 'Você pode testar clicando em  \'Ver como destinatário\' em um pedido.',
  ...
  'reminder_subject' => 'Lembrete: Pedido :invoice de :account',
  'reset' => 'Resetar',
  'invoice_not_found' => 'O pedido requisitado não está disponível',
  ...
  'disable' => 'Desabilitar',
  'invoice_quote_number' => 'Numero de Pedidos e Orçamentos',
  'invoice_charges' => 'Encargos do Pedido',
  ...
  'notification_invoice_bounced' => 'Não foi possível entregar o Pedido :invoice para :contact.',
  'notification_invoice_bounced_subject' => 'Pedido :invoice não foi entregue',
  ...
  'no_longer_running' => 'Este pedido não está agendada',
  ...
  'pattern_help_1' => 'Crie numeração personalizada para pedidos e orçamentos utilzando padrões.',
  'pattern_help_2' => 'Variáveis disponíveis:',
  'pattern_help_3' => 'Exemplo, :example seria convertido para :value',
  'see_options' => 'Veja as Opções',
  'invoice_counter' => 'Contador de Pedidos',
  ...
  'activity_4' => ':user criou o pedido :invoice',
  'activity_5' => ':user atualizou o pedido :invoice',
  'activity_6' => ':user enviou o pedido :invoice para :contact',
  'activity_7' => ':contact visualizou o pedido :invoice',
  'activity_8' => ':user arquivou o pedido :invoice',
  'activity_9' => ':user removeu o pedido :invoice',
  'activity_10' => ':contact efetuou o pagamento de :payment para o pedido :invoice',
  ...
  'activity_25' => ':user restaurou o pedido :invoice',
  ...
  'default_invoice_terms' => 'Condições Padrões dos Pedidos',
  'default_invoice_footer' => 'Rodapé Padrão dos Pedidos',
  ...
  'archive_recurring_invoice' => 'Arquivar Pedido Recorrente',
  'archived_recurring_invoice' => 'Pedido Recorrente arquivada',
  'delete_recurring_invoice' => 'Remover Pedido Recorrente',
  'deleted_recurring_invoice' => 'Pedido Recorrente removida',
  'restore_recurring_invoice' => 'Restaurar Pedido Recorrente',
  'restored_recurring_invoice' => 'Pedido Recorrente restaurada',
  'archived' => 'Arquivado',
